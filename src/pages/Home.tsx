  ...
  return (
    <>
      <div 
        ...
        style={{
          backgroundImage: 'url("https://i.imghippo.com/files/TmQS11729002670.jpg")',
          backgroundAttachment: 'fixed',
        }}
      ></div>
      <section className="relative min-h-screen flex items-center">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-5xl font-light text-black sm:text-6xl mb-6 tracking-wide">®Vecco</h2>
          <p className="mt-4 text-xl text-gray-800 mb-12 font-light">עיצוב מינימליסטי ויוקרתי לחלל שלך</p>
          <button
      ...
      <section id="contact" className="relative z-10 bg-white py-24">
